...
> ⚠️ **Key Insight**: Post-route timing with SPEF is **always more accurate** than pre-route estimates. This is why **sign-off STA** requires SPEF.
